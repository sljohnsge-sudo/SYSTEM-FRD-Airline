...
new_func = '''function renderB2CHotelResults(hotels) {
        ...
        function viewHotelDetails(hotelName, hotelLoc, hotelDesc, roomImg, roomsDataRaw, checkin, checkout, nights) {
...
with open(path, 'w', encoding='utf-8') as f:
    f.write(new_content)
print('b2c_home.html updated successfully!')
